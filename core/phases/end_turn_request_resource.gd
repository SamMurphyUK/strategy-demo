extends Resource
class_name EndTurnRequestResource
...
static func from_command(cmd: Command, current_phase: String) -> EndTurnRequestResource:
	var request := EndTurnRequestResource.new()
